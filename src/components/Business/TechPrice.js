          ...
          <div class="flex flex-wrap -m-4">
            <div class="p-4 xl:w-1/2 md:w-1/2 w-full">
              <div class="h-full p-6 rounded-lg border-2 border-gray-300 flex flex-col relative overflow-hidden">
                ...
                <p class="flex items-center text-gray-600 mb-2">
                  ...
                  Subscription cost varies depending on sale
                </p>
                <p class="flex items-center text-gray-600 mb-2">
                  <span class="w-4 h-4 mr-2 inline-flex items-center justify-center bg-gray-400 text-white rounded-full flex-shrink-0">
                    <svg
                ...
                <p class="flex items-center text-gray-600 mb-6">
                  ...
                  Transportation cost not included in the plan
                </p>
            ...
            <div class="p-4 xl:w-1/2 md:w-1/2 w-full">
              <div class="h-full p-6 rounded-lg border-2 border-first flex flex-col relative overflow-hidden">
                ...
                <h1 class="text-5xl text-gray-900  leading-snug flex items-center pb-4 mb-4 border-b border-gray-200">
                  <span>
                    {/* ? "Pay us according to your sales" */}
                    Licencing for worldwide use of Meto-Crate
                  </span>
                </h1>
                <p class="flex items-center text-gray-600 mb-2">
                  <span class="w-4 h-4 mr-2 inline-flex items-center justify-center bg-gray-400 text-white rounded-full flex-shrink-0">
                  ...
                  Add our technology in your clothes
                </p>
                <p class="flex items-center text-gray-600 mb-2">
                  <span class="w-4 h-4 mr-2 inline-flex items-center justify-center bg-gray-400 text-white rounded-full flex-shrink-0">
                    <svg
                ...
                <p class="flex items-center text-gray-600 mb-2">
                  ...
                  Pricing Varies depending on your business
                </p>
                <p class="flex items-center text-gray-600 mb-6">
                  <span class="w-4 h-4 mr-2 inline-flex items-center justify-center bg-gray-400 text-white rounded-full flex-shrink-0">
                    <svg
                  ...
                  Worldwide Sale For your products
                </p>
